          ...
          <div className="row clearfix">
            <div className="col-md-12 column">
              <div id="no-more-tables">
                ...
                >
                  <caption>
                    <h3 style={{ width: '0 auto', borderRadius: '0.25em', textAlign: 'center', width: "340px", border: '1px solid green', padding: '0.5em', margin: '0 auto' }}>Create your grocery list</h3>
                  </caption>
                ...
                <button style={{ marginLeft: '10px' }} onClick={this.handleAddRow}>Add Row</button>
              </div>
            </div>
          </div>
        </div>
